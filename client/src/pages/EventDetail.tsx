                          ...
                          <div className="flex items-center space-x-4">
                            ...
                            <div className="flex-1">
                              ...
                              <p className={`text-sm ${signup.is_finished ? 'text-gray-400' : 'text-gray-600'}`}>
                                {signup.user_id ? <Link to={`/users/${signup.user_slug}`} className="hover:underline">{signup.user_name}</Link> : (signup.user_name || 'Walk-in performer')} • {signup.performance_type}
                              </p>
                              {signup.notes && (
                    ...
                    return currentPerformer ? (
                      <div className="mb-6 p-4 bg-green-50 border border-green-200 rounded-lg">
                        ...
                        <div className="text-green-700">
                          ...
                          <p className="text-sm">{currentPerformer.user_id ? <Link to={`/users/${currentPerformer.user_slug}`} className="hover:underline">{currentPerformer.user_name}</Link> : 'Walk-in performer'} • {currentPerformer.performance_type}</p>
                        </div>
                            ...
                            >
                              <div>
                                ...
                                <p className="text-sm text-gray-400">
                                  {signup.user_id ? <Link to={`/users/${signup.user_slug}`} className="hover:underline">{signup.user_name}</Link> : 'Walk-in performer'} • {signup.performance_type}
                                </p>
                              </div>
                              <button
                                onClick={() => handleUnmarkFinished(signup.id)}
                    ...
                    (() => {
                      ...
                      return currentPerformer ? (
                        <div className="p-6 bg-green-50 border border-green-200 rounded-lg text-center">
                          ...
                          <p className="text-green-700">{currentPerformer.user_id ? <Link to={`/users/${currentPerformer.user_slug}`} className="hover:underline">{currentPerformer.user_name}</Link> : 'Walk-in performer'}</p>
